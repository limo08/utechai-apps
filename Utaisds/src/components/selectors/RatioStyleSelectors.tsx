...
const TRIGGER_TEXT_CLASSNAME = 'text-sm font-medium text-[var(--glass-text-primary)]'
...
export function StylePresetBadge({
  ...
  return (
    <div className="glass-input-base relative flex h-10 w-full items-center gap-2 overflow-hidden px-2.5">
      ...
      <span className="relative min-w-0 flex-1 truncate text-sm font-semibold text-[var(--glass-text-primary)]">
        {label}
      </span>
      <span className="relative shrink-0 rounded-full bg-[var(--glass-tone-info-bg)] px-1.5 py-0.5 text-xs font-semibold text-[var(--glass-tone-info-fg)]">
        {description}
      </span>
    </div>
  )
