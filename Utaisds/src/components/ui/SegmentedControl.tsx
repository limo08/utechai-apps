            ...
            >
                ...
                {options.map((opt) => (
                    <button
                        ...
                        className={`relative z-10 flex items-center justify-center gap-1.5 rounded-[10px] px-3 py-1.5 text-sm font-semibold transition-colors duration-200 cursor-pointer ${value === opt.value
