...
export function ModelCapabilityDropdown({
    ...
    const modelOptionTextSize = compact ? 'text-sm' : 'text-sm'
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                        {selectedModel && (paramSummary || selectedModel.providerName || selectedModel.provider) && (
                            <span className="relative group/info">
                                ...
                                <span className="pointer-events-none absolute right-0 bottom-full mb-2 whitespace-nowrap rounded-lg bg-[var(--glass-text-primary)] px-3 py-1.5 text-sm text-white opacity-0 transition-opacity group-hover/info:opacity-100 z-50 shadow-lg">
                                        ...
                                        {visibleCapabilityFields.map((def) => {
                                            ...
                                            return (
                                                <div key={def.field} className="flex items-center justify-between gap-3">
                                                    <span className="text-sm text-[var(--glass-text-secondary)] font-semibold shrink-0">
                                                        {resolveCapabilityLabel(def)}
                                                    </span>
                                                    {def.options.length === 1 ? (
                                                        <span className="text-xs font-medium px-2.5 py-1 rounded-md bg-[var(--glass-bg-surface-strong)] border border-[var(--glass-stroke-base)] text-[var(--glass-text-secondary)] flex items-center gap-1">
                                                            {(() => {
                                                            ...
                                                            <span className="text-[var(--glass-text-tertiary)] text-xs">({t('fixed')})</span>
                                                        </span>
                                                    ) : useSelect ? (
                                                        <div className="relative group">
                                                            <select
                                                                ...
                                                                className="appearance-none bg-transparent hover:bg-[#f2f2f7] dark:hover:bg-[#1c1c1e] text-sm font-bold text-[var(--glass-text-primary)] pl-3 pr-7 py-1 rounded-md transition-colors outline-none cursor-pointer border border-transparent"
                                                            >
                                                                {def.options.map((opt) => {
                                                                    const s = String(opt)
                                                                    return (
                                                            ...
                                                            {def.options.map((opt) => {
                                                                ...
                                                                return (
                                                                    <button
                                                                        ...
                                                                        className={`px-3 py-1.5 text-sm font-medium rounded-md transition-all flex items-center gap-1 cursor-pointer ${on
                                            ...
                                            <div key={toggle.key} className="flex items-center justify-between gap-3">
                                                ...
                                                <div className="flex bg-[#f2f2f7] dark:bg-[#1c1c1e] p-[3px] rounded-lg shadow-inner">
                                                    <button
                                                        ...
                                                        className={`px-3 py-1.5 text-sm font-medium rounded-md transition-all ${toggle.value
                                                            ? 'bg-white text-black dark:bg-[#2c2c2e] dark:text-white shadow-[0_3px_8px_rgba(0,0,0,0.12),0_3px_1px_rgba(0,0,0,0.04)] font-bold'
                                                            : 'text-[#8e8e93] hover:text-[#3a3a3c] dark:hover:text-[#ebebf5]'
                                                            }`}
                                                    >
