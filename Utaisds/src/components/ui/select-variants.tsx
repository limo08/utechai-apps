                    ...
                    {selectedOption ? (
                        <div className="flex flex-col">
                            ...
                            {selectedOption.description && (
                                <span className="text-xs text-[var(--glass-text-tertiary)] truncate mt-0.5">
                                    {selectedOption.description}
                                </span>
                            )}
                        </div>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {opt.description && (
                                                <div className={`text-xs mt-0.5 ${isSelected ? 'text-[var(--glass-tone-info-fg)] opacity-80' : 'text-[var(--glass-text-tertiary)]'}`}>
                                                    {opt.description}
                                                </div>
                                            )}
                                        </div>
...
export function SelectVariantGhost({
    ...
    return (
        <>
            ...
            >
                <span className={`text-sm whitespace-nowrap overflow-hidden text-ellipsis ${selectedOption ? 'font-medium text-[var(--glass-text-secondary)]' : 'text-[var(--glass-text-tertiary)]'}`}>
                        ...
                        <div className="overflow-y-auto app-scrollbar p-1 max-h-full space-y-0.5">
                            {options.map((opt) => {
                                ...
                                return (
                                    ...
                                    >
                                        <span className={`flex-1 min-w-0 text-sm ${isSelected ? 'font-medium' : ''}`}>
                                            {opt.label}
                                        </span>
                                        {isSelected && (
