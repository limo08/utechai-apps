      ...
      <header className="border-b border-[var(--glass-stroke-base)] px-5 py-5 md:px-6">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-[15rem_minmax(0,1fr)_auto] md:items-center">
          <div className="glass-surface-soft rounded-xl border border-[var(--glass-stroke-base)] p-3">
            <p className="text-xs uppercase tracking-[0.12em] text-[var(--glass-text-tertiary)]">
              {t('stageCard.stage')}
            </p>
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex min-w-0 items-center gap-2">
                          <span className="glass-chip glass-chip-neutral min-w-6 justify-center rounded-md px-1.5 py-0.5 text-xs font-semibold leading-none">
                            {index + 1}
                          </span>
                          {attempt > 1 && (
                            <span className="glass-chip glass-chip-warning min-w-6 justify-center rounded-md px-1.5 py-0.5 text-xs font-semibold leading-none">
                              ×{attempt}
                            </span>
                          )}
                    ...
                    {showRetryButton && (
                      <div className="mt-2 flex justify-end">
                        <button
                          ...
                          className="glass-btn-base glass-btn-primary rounded-md px-2.5 py-1 text-xs"
                        >
                          重试
                        </button>
                      </div>
