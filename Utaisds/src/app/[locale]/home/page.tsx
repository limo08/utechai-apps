    ...
    <div className="glass-page min-h-screen">
      ...
      <main className="flex flex-col items-center pt-[13vh] pb-12 px-4 max-w-5xl mx-auto w-full">
        ...
        <div className="w-full relative p-5">
          ...
          >
            ...
            <span className="text-xs font-mono font-bold tracking-widest text-red-500/70">REC</span>
          </span>
      ...
      <section className="px-4 sm:px-6 lg:px-10 pb-8 max-w-[1400px] mx-auto w-full">
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-semibold text-[var(--glass-text-secondary)]">{t('recentProjects')}</h2>
          <Link
            ...
            {projects.map((project) => (
              ...
              >
                ...
                <div className="p-5 relative z-10">
                  <h3 className="text-lg font-bold text-[var(--glass-text-primary)] mb-2 group-hover:text-[var(--glass-tone-info-fg)] transition-colors line-clamp-1">
                    {project.name}
                  </h3>
