      ...
      <div className="p-2 bg-[var(--glass-tone-info-bg)] border border-[var(--glass-stroke-focus)] rounded-lg">
        ...
        <div className="flex gap-2 items-center">
          <div className="flex-1 bg-[var(--glass-bg-muted)] rounded overflow-hidden relative" style={{ aspectRatio: cssAspectRatio }}>
            ...
            <span className="absolute bottom-1 left-1 bg-[var(--glass-accent-from)] text-white text-xs px-1 rounded">{t("firstLastFrame.firstFrame")}</span>
          </div>
          ...
          <div className="flex-1 bg-[var(--glass-bg-muted)] rounded overflow-hidden relative" style={{ aspectRatio: cssAspectRatio }}>
            ...
            <span className="absolute bottom-1 left-1 bg-[var(--glass-tone-warning-fg)] text-white text-xs px-1 rounded">{t("firstLastFrame.lastFrame")}</span>
          </div>
        </div>
        {/* 首尾帧提示词编辑 */}
        <div className="mt-2">
