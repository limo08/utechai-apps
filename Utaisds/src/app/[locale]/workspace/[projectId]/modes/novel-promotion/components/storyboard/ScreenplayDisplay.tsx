                            ...
                            <div key={sceneIndex} className="border-l-2 border-[var(--glass-stroke-focus)] pl-3 space-y-2">
                                ...
                                {scene.characters && scene.characters.length > 0 && (
                                    <div className="flex gap-1 flex-wrap items-center">
                                        <span className="text-xs text-[var(--glass-text-tertiary)]">{t('screenplay.characters')}</span>
                                        {scene.characters.map((name, index) => (
                                            <span key={`${name}-${index}`} className="text-xs text-[var(--glass-text-secondary)] bg-[var(--glass-bg-muted)] px-1.5 py-0.5 rounded">
                                                {name}
                                            </span>
                                        ))}
                                    </div>
