...
function SectionLabel({ children }: { children: string }) {
  return (
    <div className="flex items-center gap-2 mb-2.5">
      ...
      <span className="text-xs font-semibold text-[var(--glass-text-primary)]">{children}</span>
    </div>
  )
}
    ...
    <div className="border border-[var(--glass-stroke-base)] rounded-[var(--glass-radius-xs)] overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-[var(--glass-text-secondary)]">{label}</span>
        </div>
        <AppIcon
                ...
                {photoChar && (
                  <div>
                    ...
                    <div className="space-y-2">
                      <div>
                        <p className="text-xs text-[var(--glass-text-tertiary)] mb-1">{t('aiData.screenPosition')}</p>
                        <GlassInput
                          density="compact"
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <p className="text-xs text-[var(--glass-text-tertiary)] mb-1">{t('aiData.posture')}</p>
                          <GlassInput
                            density="compact"
                        ...
                        <div>
                          <p className="text-xs text-[var(--glass-text-tertiary)] mb-1">{t('aiData.facing')}</p>
                          <GlassInput
                            density="compact"
