            ...
            <ImageGenerationInlineCountButton
              prefix={isTaskRunning ? (
                <>
                  ...
                  <span className="text-xs font-medium text-[var(--glass-tone-info-fg)]">{tAssets('image.regenCountPrefix')}</span>
                </>
              ) : (
                <>
      ...
      <div className="p-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-[var(--glass-text-tertiary)]">{assetLabel}</p>
          </div>
