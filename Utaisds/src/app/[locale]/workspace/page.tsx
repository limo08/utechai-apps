    ...
    <div className="glass-page min-h-screen">
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 py-8">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-[var(--glass-text-primary)] mb-2">{t('title')}</h1>
            <p className="text-base text-[var(--glass-text-secondary)]">{t('subtitle')}</p>
          </div>
                ...
                <div className="p-5 relative z-10">
                  ...
                  <div className="flex items-center justify-between text-xs text-[var(--glass-text-tertiary)]">
                    ...
                    {project.totalCost !== undefined && project.totalCost > 0 && (
                      <span className="text-xs font-mono font-medium text-[var(--glass-text-secondary)]">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 glass-overlay flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="glass-surface-modal p-6 w-full max-w-md mx-4">
            <h2 className="text-lg font-bold text-[var(--glass-text-primary)] mb-4">{t('createProject')}</h2>
            {modelNotConfigured && (
      ...
      {showEditModal && editingProject && (
        <div className="fixed inset-0 glass-overlay flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="glass-surface-modal p-6 w-full max-w-md mx-4">
            <h2 className="text-lg font-bold text-[var(--glass-text-primary)] mb-4">{t('editProject')}</h2>
