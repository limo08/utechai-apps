      ...
      {currentType && (
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-2 text-sm font-semibold text-[var(--glass-text-primary)]">
            ...
            <span className="rounded-full bg-[var(--glass-tone-neutral-bg)] px-1.5 py-0.5 text-xs font-semibold text-[var(--glass-tone-neutral-fg)]">
          ...
          {shouldShowAddButton && (
            <button
              ...
              className="glass-btn-base glass-btn-soft px-2 py-1 text-sm font-medium"
            >
        ...
        <div className="glass-surface-soft rounded-xl p-3">
          <div className="mb-2.5 flex items-center gap-2">
            <input
              ...
              className="glass-input-base px-3 py-1.5 text-sm"
              autoFocus
            />
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className={`glass-input-base flex-1 px-3 py-1.5 text-sm font-mono ${currentType === 'video' && state.batchMode && provider.id === 'ark' ? 'rounded-r-none' : ''}`}
            />
            {currentType === 'video' && state.batchMode && provider.id === 'ark' && (
              <span className="rounded-r-lg bg-[var(--glass-bg-muted)] px-2 py-1.5 font-mono text-sm text-[var(--glass-text-secondary)]">
                -batch
              </span>
            )}
            <button
              ...
              className="glass-btn-base glass-btn-primary px-3 py-1.5 text-sm font-medium"
            >
    ...
    <div className="p-3">
      {state.showAddForm === null ? (
        <div className="text-center">
          <p className="mb-3 text-sm text-[var(--glass-text-tertiary)]">{t('noModelsForProvider')}</p>
        ...
        <div className="glass-surface-soft rounded-xl p-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              placeholder={t('modelActualId')}
              className="glass-input-base flex-1 px-3 py-1.5 text-sm font-mono"
            />
            <button
        ...
        <>
          <div className="flex min-w-0 flex-1 flex-col gap-2">
            ...
            <input
              ...
              className="glass-input-base w-full px-3 py-1.5 text-sm font-mono"
              placeholder={t('modelActualId')}
            />
            {hasPriceText && (
        ...
        <>
          <div className="flex min-w-0 flex-1 flex-col gap-0.5">
            <div className="flex flex-wrap items-center gap-2">
              <span className={`text-sm font-semibold ${model.enabled ? 'text-[var(--glass-text-primary)]' : 'text-[var(--glass-text-secondary)]'}`}>
                {model.name}
              </span>
              {state.isDefaultModel(model) && model.enabled && (
                <span className="shrink-0 rounded-md bg-[var(--glass-text-primary)] px-1.5 py-0.5 text-xs leading-none text-white">
                  {t('default')}
                </span>
              )}
              {hasPriceText && (
                <span className="shrink-0 text-xs text-[var(--glass-text-tertiary)]">{priceText}</span>
              )}
            </div>
            <span className="break-all text-xs text-[var(--glass-text-tertiary)]">{model.modelId}</span>
          </div>
