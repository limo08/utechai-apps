      ...
      <div className="flex items-center justify-between px-3.5 py-2.5">
        <div className="flex items-center gap-2">
          ...
          {compatibilityLayerLabel && (
            <span className="rounded-full border border-[var(--glass-stroke-base)] bg-[var(--glass-bg-muted)] px-2 py-0.5 text-xs font-semibold text-[var(--glass-text-secondary)]">
              {compatibilityLayerLabel}
            </span>
          )}
          {/* 连接状态图标 */}
        ...
        <div className="flex items-center gap-1.5">
          ...
          {state.tutorial && (
            <button
              ...
              className="glass-btn-base cursor-pointer flex items-center gap-1 rounded-lg border border-[var(--glass-stroke-base)] bg-transparent px-2 py-1 text-sm font-medium text-[var(--glass-text-primary)] hover:border-[var(--glass-stroke-strong)] hover:bg-[var(--glass-bg-muted)] hover:text-[var(--glass-text-primary)]"
            >
